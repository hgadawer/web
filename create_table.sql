...
CREATE TABLE `business` (
  ...
  KEY `idx_creator` (`creator`),
	CONSTRAINT `fk_business_customer` FOREIGN KEY (`cid`) REFERENCES `customer`(`id`)
...
/*合同表*/
DROP TABLE IF EXISTS `contract`;--合同表
...
CREATE TABLE `product` (
  ...
  `code` varchar(80) DEFAULT NULL COMMENT '名称',
...
CREATE TABLE role (
  ...
  role_name VARCHAR(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '角色标识(ROLE_开头)',
  description VARCHAR(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci COMMENT '角色描述'
